...
# 2. Configure database (update config.py)
...
**System Status**: `http://localhost:8000/api/index_status`

For production deployment, consider using gunicorn or similar ASGI server with proper SSL configuration.
